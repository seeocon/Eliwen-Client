...
public class Loader extends Applet {
	...
	public static final String CLIENT_TITLE = "Incatasi";
	public static final String FRAME_TITLE = "Incatasi";
	public static final String SERVER_IP = "incatasi.no-ip.biz";
	...
	void setParams() {
		...
		client_parameters.put("java_arguments", "-Xmx4096m -Xss2m -Dsun.java2d.noddraw=true -XX:CompileThreshold=1500 -Xincgc -XX:+UseConcMarkSweepGC -XX:+UseParNewGC");
	...
	public static String getCacheDir() {
		return System.getProperty("user.home") + "/Incatasi/incatasi/live";
	}
