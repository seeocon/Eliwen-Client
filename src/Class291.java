...
public abstract class Class291 implements Interface14, Runnable, FocusListener, WindowListener {
	...
	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			...
			Class180.aFile6528 = new File(Class83.aString765, new StringBuilder().append("incatasi_").append(string).append("_").append(string_27_).append(string_29_).append(".dat").toString());
