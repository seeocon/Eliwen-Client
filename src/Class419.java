		...
		try {
			do {
				try {
					...
					Class302_Sub3_Sub1_Sub1.color = 0xff0000;
				} else if (string.equalsIgnoreCase("cyan")) {
					Class302_Sub3_Sub1_Sub1.color = 0x00ffff;
				} else if (string.equalsIgnoreCase("normal")) {
					Class302_Sub3_Sub1_Sub1.color = 0x99ccff;
				} else if (string.equalsIgnoreCase("black")) {
					Class302_Sub3_Sub1_Sub1.color = 0x000000;
				} else if (string.equalsIgnoreCase("blue")) {
					Class302_Sub3_Sub1_Sub1.color = 0x0000ff;
				} else if (string.equalsIgnoreCase("lime")) {
					Class302_Sub3_Sub1_Sub1.color = 0x00ff00;
				} else if (string.equalsIgnoreCase("pink")) {
					Class302_Sub3_Sub1_Sub1.color = 0xff00ff;
				} else if (string.equalsIgnoreCase("yellow")) {
					Class302_Sub3_Sub1_Sub1.color = 0xffff00;
				} else if (string.equalsIgnoreCase("purple")) {
					Class302_Sub3_Sub1_Sub1.color = 0x800080;
				} else if (string.equalsIgnoreCase("green")) {
					Class302_Sub3_Sub1_Sub1.color = 0x008000;
